...
export default function ReportsPage() {
  ...
  const { data: summary, isLoading } = useQuery<Summary>({
    queryKey: ["reports-summary", branchId, type, dateFrom, dateTo],
  ...
  return (
    <>
      <PageHeader title="Reports" breadcrumb="Admin" />
      ...
      <GlassCard>
        ...
        <p className="text-xs text-white/40 mb-4">
          Export uses the same filters applied above. XLSX includes all fields; PDF is a formatted summary.
        </p>
